 ...
 * @author Paulino
 */
@WebServlet(name = "EditarRealizaServlet", urlPatterns = {"/EditarRealizaServlet"})
public class EditarRealizaServlet extends HttpServlet {
    ...
    @Override
     protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            realizaDao.updateRealiza(realiza);
